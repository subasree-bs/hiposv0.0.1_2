...
return (
    <>
    <Box>
    <Typography sx={userStyle.HeaderText}>Sell Payment Report</Typography>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item sm={12} xs={12} md={6} lg={3}>
                                <Grid sx={{ display: 'flex' }}  >
                                    ...
                                    <Grid item sm={12} xs={12} md={6} lg={3}>
                                        <Grid sx={{ display: 'flex' }}  >
                                            <Grid sx={userStyle.spanIcons}><FaMoneyBill /></Grid>
                                                <FormControl size="small" fullWidth sx={{ display: 'flex',borderRadius:'0px !important' }}>
                         ...
                         <TableContainer component={Paper} sx={{boxShadow:'none'}}>
                                <Grid container sx={userStyle.gridcontainer}>    
                                    ...
                                    <TableFooter sx={{backgroundColor: '#9591914f', height: '75px'}}>
                                        <StyledTableRow> 
                                            <StyledTableCell align="left"sx={userStyle.footerStyle} colspan={3}>Total</StyledTableCell>

...
function TaxGrpEdit() {
  ...
  return (
    <>
      <Button variant="contained" onClick={handleClickOpen} sx={userStyle.buttonedit} color="primary"><EditOutlinedIcon style={{ fontSize: 'large' }} />&ensp;EDIT</Button>
      ...
      <Dialog PaperProps={{ style: { borderRadius: "10px" } }} onClose={handleClose} open={open} keepMounted aria-describedby="alert-dialog-slide-description" >
        <DialogTitle id="customized-dialog-title" onClose={handleClose}> Edit tax group</DialogTitle>

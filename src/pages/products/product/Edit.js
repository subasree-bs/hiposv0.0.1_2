...
function Producteditlist() {
    ...
    return (
        <Box>
            <form action=''>
                {/* header text */}
                <Typography sx={userStyle.HeaderText}>Edit products</Typography>
                {/* content start */}
                    ...
                    <Grid container spacing={2} sx={{ padding: '40px 20px', }}>
                        ...
                        <Grid item md={3} sm={12} xs={12}>
                            <FormControl size="small" fullWidth>
                                ...
                                <Typography variant='body2' sx={{ opacity: '0.9', mt: 1 }}>Max File size: 5MB <br />
                                    Allowed File: .pdf, .csv, .zip, .doc, .docx, .jpeg, .jpg, .png</Typography>
                            </FormControl>
                        </Grid>

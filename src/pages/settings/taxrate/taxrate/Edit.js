...
import { TextField,IconButton,DialogActions,DialogContent,DialogTitle,Dialog,Button, Grid ,Box,InputLabel,FormControl,OutlinedInput,InputAdornment,Table,FormControlLabel,Checkbox,FormGroup,TableRow,TableHead,TableContainer,TableBody,TableCell,Paper} from '@mui/material';
...
<>
  <Button variant="contained" onClick={handleClickOpen} sx={userStyle.buttonedit} ><EditOutlinedIcon style={{fontSize:'large'}}/>&ensp;EDIT&ensp;</Button>
      <Dialog PaperProps={{style: { borderRadius:"10px"}}} onClose={handleClose} open={open} keepMounted aria-describedby="alert-dialog-slide-description">
        <DialogTitle id="customized-dialog-title" onClose={handleClose}> Edit Tax Rate </DialogTitle>

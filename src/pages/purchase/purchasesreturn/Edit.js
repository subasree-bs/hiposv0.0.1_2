...
// ******** Text field ******** //
const [purchaseRetEdit, setPurchaseRetEdit] = useState({
    purchaseRetEditSuppler: "", purchaseRetEditBusinessLoc: "", purchaseRetEditRefNo: "", purchaseRetEditDate: "", purchaseRetEditPurTax: "",
    purchaseRetEditSearch: "",
});
                        ...
                        <Grid sx={{ display: 'flex' }}  >
                            ...
                            <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                ...
                                <Select
                                    ...
                                    value={purchaseRetEdit.purchaseRetEditSupplier}
                                    onChange={(e) => { setPurchaseRetEdit({ ...purchaseRetEdit, purchaseRetEditSupplier: e.target.value }) }}
                                    label="Customer"
                                    fullWidth
                                >
                    ...
                    <Grid item md={3} sm={6} xs={12}>
                        <FormControl size="small" fullWidth>
                            ...
                            <Select
                                labelId="demo-select-small"
                                id="demo-select-small"
                                value={purchaseRetEdit.purchaseRetEditBusinessLoc}
                                onChange={(e) => { setPurchaseRetEdit({ ...purchaseRetEdit, purchaseRetEditBusinessLoc: e.target.value }) }}
                        ...
                        <Grid sx={{ display: 'flex' }}  >
                            ...
                            <FormControl size="small" fullWidth >
                                ...
                                <OutlinedInput
                                    ...
                                    value={purchaseRetEdit.purchaseRetEditSearch}
                                    onChange={(e) => { setPurchaseRetEdit({ ...purchaseRetEdit, purchaseRetEditSearch: e.target.value }) }}
                                    type="search"
                    ...
                    <Grid item lg={4} md={4} sm={4} xs={12}>
                        <FormControl size="small" fullWidth>
                            ...
                            <Select
                                labelId="demo-select-small"
                                id="demo-select-small"
                                value={purchaseRetEdit.purchaseRetEditPurTax}
                                onChange={(e) => { setPurchaseRetEdit({ ...purchaseRetEdit, purchaseRetEditPurTax: e.target.value }) }}
                                label="Purchase Tax"
                            >

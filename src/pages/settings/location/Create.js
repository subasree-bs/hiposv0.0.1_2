...
//Add modal
const [busAddMod, setBusAddMod] = useState(false);
const busAddModOpen = () => {
setBusAddMod(true);
};
const busAddModClose = () => {
setBusAddMod(false);
};

return(
<>
<Button variant="contained" onClick={busAddModOpen} sx={userStyle.buttonadd} >ADD</Button>
    <Dialog fullWidth maxWidth="md" onClose={busAddModClose} open={busAddMod} keepMounted aria-describedby="alert-dialog-slide-description">
        <DialogTitle id="customized-dialog-title" onClose={busAddModClose}> Add a new business location     </DialogTitle>
        ...
        {/* FORM START */}
                        ...
                        <Grid item xs={12} sm={12} md={6}>
                            <FormControl fullWidth>
                                ...
                                <Select labelId="demo-simple-select-label" id="demo-simple-select" label='Invoice scheme' size='small' sx={{borderRadius:'0px !important'}}
                                        endAdornment={      
                                            <InputAdornment position="end"><IconButton aria-label="toggle password visibility" edge="end" ><FcInfo /></IconButton></InputAdornment>
                                         }
                                >
                                    ...
                                    <FormControl variant="outlined" size="small" fullWidth>
                                            <InputLabel htmlFor="outlined-adornment-password">Pay Term</InputLabel>
                                                <OutlinedInput
                                                    ...
                                                    endAdornment={
                                                    <InputAdornment position="end">
                                                                <IconButton aria-label="toggle password visibility" edge="end" ><FcInfo /> </IconButton>
                                                    </InputAdornment>
                                                    }
                                                    label="Pay Term"
                                                />
                ...
                <DialogActions>
                    ...
                    <Button  variant="contained" color="error" autoFocus onClick={busAddModClose}>   Close</Button>
                </DialogActions>
    </Dialog>
</>
);

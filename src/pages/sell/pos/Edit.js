...
const Posedit = ()=>{
   ...
   const [posEdit, setPosEdit] = useState({
    posEditLoc: "", posEditSelect: "", posEditTable: "", posEditAllBrand: "",
    posEditStaff: "",
});
                        ...
                        <Grid display="flex">
                            ...
                            <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                ...
                                <Select
                                    ...
                                    value={posEdit.posEditLoc}
                                    onChange={(e) => { setPosEdit({ ...posEdit, posEditLoc: e.target.value }) }}
                                    label="xxx"
                                    fullWidth
                                >
                                ...
                                <Grid sx={{ display: 'flex' }}  >
                                    ...
                                    <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                        ...
                                        <Select
                                            labelId="demo-select-small"
                                            id="demo-select-small"
                                            // value={posEdit.posEditb}
                                            // onChange={(e) => { setPosEdit({ ...posEdit, posEditbrand: e.target.value }) }}
                                ...
                                <Grid sx={{ display: 'flex' }}  >
                                    ...
                                    <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                        ...
                                        <Select
                                            labelId="demo-select-small"
                                            id="demo-select-small"
                                            value={posEdit.posEditSelect}
                                            onChange={(e) => { setPosEdit({ ...posEdit, posEditSelect: e.target.value }) }}
                                ...
                                <Grid sx={{ display: 'flex' }}  >
                                    ...
                                    <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                        ...
                                        <Select
                                            labelId="demo-select-small"
                                            id="demo-select-small"
                                            value={posEdit.posEditTable}
                                            onChange={(e) => { setPosEdit({ ...posEdit, posEditTable: e.target.value }) }}
                                            label="Select Table"
                                            fullWidth
                                        >
                                ...
                                <Grid sx={{ display: 'flex' }}  >
                                    ...
                                    <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                        ...
                                        <Select
                                            labelId="demo-select-small"
                                            id="demo-select-small"
                                            value={posEdit.posEditStaff}
                                            onChange={(e) => { setPosEdit({ ...posEdit, posEditStaff: e.target.value }) }}
                            ...
                            <Grid item md={5} sm={12} xs={12}>
                                <FormControl size="small" fullWidth sx={{ display: 'flex' }}>
                                    ...
                                    <Select
                                        labelId="demo-select-small"
                                        id="demo-select-small"
                                        value={posEdit.posEditAllBrand}
                                        onChange={(e) => { setPosEdit({ ...posEdit, posEditAllBrand: e.target.value }) }}
                                        label="All Brands"
                                        fullWidth
                                    >
